...
func Plan9SimdForwardForLayer(t LayerType) bool {
	...
	switch t {
	case LayerDense, LayerSwiGLU, LayerMultiHeadAttention, LayerCNN1, LayerCNN2, LayerCNN3:
		return true
	default:
		return false
	}
...
// SetSimdForward enables Plan 9 SIMD forward (Dense, SwiGLU, MHA, CNN1, CNN2, CNN3) on the network and every layer.
