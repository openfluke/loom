# Loom / poly Documentation Index (v0.82.0)
...
| [accelerators.md](accelerators.md) | **Vendor NPU/TPU** — `poly/accel`, Intel OpenVINO CPU+NPU (experimental, Lucy [9]) + Qualcomm/Hexagon QNN (experimental, Lucy [12]); Google TPU planned; `SyncToAccel` |
...
├── accel/               Vendor plugin loader (Intel NPU/CPU dlopen; Qualcomm NPU LoadLibrary; C ABI)
├── accel_intel.go       SyncToAccel, DispatchAccelForward (Intel)
